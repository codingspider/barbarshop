                ...
                <ul class="menu-list flex-grow-1 mt-4 px-1">
                    <li>
                        <a class="m-link active" href="{{ route('admin.dashboard') }}">
                            ...
                            <div><h6 class="mb-0">@lang('Dashboard')</h6><small class="text-muted">@lang('Analytics')</small></div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="m-link" href="{{ route('admin.users.index') }}">
                            ...
                            <div><h6 class="mb-0">@lang('User')</h6><small class="text-muted">@lang('Management')</small></div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="m-link" href="{{ route('admin.currencies.index') }}">
                            ...
                            <div><h6 class="mb-0">@lang('Default')</h6><small class="text-muted">@lang('Currency')</small></div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="m-link" href="{{ route('admin.services.index') }}">
                            ...
                            <div><h6 class="mb-0">@lang('All')</h6><small class="text-muted">@lang('Services')</small></div>
                        </a>
                    </li>
