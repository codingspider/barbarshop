                                ...
                                <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0">
                                    <div class="card border-0">
                                        <ul class="list-unstyled py-2 px-3">
                                            <li>
                                                <a href="{{ route('lang.switch', 'en') }}" class=""><img src="{{ asset('admin/assets/images/flag/GB.png') }}" alt=""> English</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('lang.switch', 'ar') }}" class=""><img src="{{ asset('admin/assets/images/flag/AR.png') }}" alt=""> Arabic</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('lang.switch', 'fr') }}" class=""><img src="{{ asset('admin/assets/images/flag/FR.png') }}" alt=""> French</a>
                                            </li>
